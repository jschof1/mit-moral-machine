require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/chart.min', 'libraries/async.min', 'libraries/xapiwrapper.min', 'libraries/url-polyfill.min'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, Chart, Async, xapiwrapper_min, urlPolyfill_min) {
  ...
  class MoralMachineResultsResultsModel extends ComponentModel$1 {
    ...
    onAssessmentComplete(state, assessmentModel) {
      ...
      assessmentModel._getAllQuestionComponents().forEach(component => {
        ...
        component.getActiveItems()[0].attributes["killed characters"].length;
        component.getActiveItems()[0].attributes["saved characters"].length;
      ...
      if (finalObj.length === 0) {
        ...
        valuesForBar.map(v => {
          let total = Object.values(v)[0] + Object.values(v)[1];
              Object.values(v)[0] / total * 100;
              let totalPercent = 100 / total,
